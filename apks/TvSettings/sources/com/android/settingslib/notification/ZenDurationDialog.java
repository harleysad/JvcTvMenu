...
public class ZenDurationDialog {
    ...
    public Dialog createDialog() {
        final int zenDuration = Settings.Global.getInt(this.mContext.getContentResolver(), "zen_duration", 0);
        AlertDialog.Builder builder = new AlertDialog.Builder(this.mContext).setTitle(R.string.zen_mode_duration_settings_title).setNegativeButton(R.string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(R.string.okay, new DialogInterface.OnClickListener() {
    ...
    public void updateUi(ConditionTag tag, View row, int rowIndex) {
        ...
        switch (rowIndex) {
            case 0:
                radioContentText = this.mContext.getString(17041159);
                break;
            case 1:
