...
public class EnableZenModeDialog {
    ...
    public Dialog createDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this.mContext).setTitle(R.string.zen_mode_settings_turn_on_dialog_title).setNegativeButton(R.string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(R.string.zen_mode_enable_dialog_turn_on, new DialogInterface.OnClickListener() {
            ...
            tag.rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                        ...
                        MetricsLogger.action(EnableZenModeDialog.this.mContext, KeyMap.KEYCODE_MTKIR_MUTE);
    ...
    private String foreverSummary(Context context) {
        return context.getString(17041159);
    }
    ...
    private void updateUi(ConditionTag tag, View row, Condition condition, boolean enabled, int rowId, Uri conditionId) {
        ...
        if (this.mBucketIndex > -1) {
            ...
            String str2 = line2;
            button1.setEnabled(time - System.currentTimeMillis() > ((long) (MIN_BUCKET_MINUTES * MINUTES_MS)));
    ...
    public void onClickTimeButton(View row, ConditionTag tag, boolean up, int rowId) {
        ...
        if (this.mBucketIndex == -1) {
            ...
            while (true) {
                ...
                bucketTime = now + ((long) (MINUTES_MS * bucketMinutes));
