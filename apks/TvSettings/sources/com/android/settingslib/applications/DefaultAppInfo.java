...
public class DefaultAppInfo extends CandidateInfo {
    ...
    public DefaultAppInfo(Context context, PackageManagerWrapper pm, PackageItemInfo info) {
        this(context, pm, info, (String) null, true);
    }

    public DefaultAppInfo(Context context, PackageManagerWrapper pm, int uid, ComponentName cn, String summary2, boolean enabled) {
        super(enabled);
    ...
    public DefaultAppInfo(Context context, PackageManagerWrapper pm, PackageItemInfo info, String summary2, boolean enabled) {
        super(enabled);
        this.mContext = context;
        this.mPm = pm;
