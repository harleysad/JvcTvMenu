...
public final class UserManagerHelper {
    ...
    public OnUsersUpdateListener mUpdateListener;
    ...
    public boolean currentProcessCanModifyAccounts() {
        return !currentProcessHasUserRestriction("no_modify_accounts") && !currentProcessRunningAsDemoUser() && !currentProcessRunningAsGuestUser();
    }
    ...
    private void registerReceiver() {
        ...
        this.mContext.registerReceiverAsUser(this.mUserChangeReceiver, UserHandle.ALL, filter, (String) null, (Handler) null);
    }
