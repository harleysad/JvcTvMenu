...
public abstract class AbstractWifiMacAddressPreferenceController extends AbstractConnectivityPreferenceController {
    ...
    public void updateConnectivity() {
        ...
        int macRandomizationMode = Settings.Global.getInt(this.mContext.getContentResolver(), "wifi_connected_mac_randomization_enabled", 0);
        ...
        if (TextUtils.isEmpty(macAddress)) {
            ...
            this.mWifiMacAddress.setSummary((CharSequence) macAddress);
        } else {
