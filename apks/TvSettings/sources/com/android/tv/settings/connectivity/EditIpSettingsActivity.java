...
public class EditIpSettingsActivity extends InstrumentedActivity implements State.FragmentChangeListener {
    ...
    private final StateMachine.Callback mStateMachineCallback = new StateMachine.Callback() {
        public final void onFinish(int i) {
            EditIpSettingsActivity.lambda$new$0(EditIpSettingsActivity.this, i);
        }
    };

    public static Intent createIntent(Context context, int networkId) {
        return new Intent(context, EditIpSettingsActivity.class).putExtra(EXTRA_NETWORK_ID, networkId);
    }

    public static /* synthetic */ void lambda$new$0(EditIpSettingsActivity editIpSettingsActivity, int result) {
        editIpSettingsActivity.setResult(result);
        editIpSettingsActivity.finish();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AdvancedWifiOptionsFlow.createFlow(this, false, true, netConfig, (State) null, this.mSaveState, 1);
