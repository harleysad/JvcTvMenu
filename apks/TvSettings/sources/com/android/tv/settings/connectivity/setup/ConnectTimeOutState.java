...
public class ConnectTimeOutState implements State {
    ...
    public void processForward() {
        AdvancedOptionsFlowInfo advInfo = (AdvancedOptionsFlowInfo) ViewModelProviders.of(this.mActivity).get(AdvancedOptionsFlowInfo.class);
        advInfo.setCanStart(true);
        advInfo.setPrintableSsid(((UserChoiceInfo) ViewModelProviders.of(this.mActivity).get(UserChoiceInfo.class)).getWifiConfiguration().getPrintableSsid());
        this.mFragment = new ConnectTimeOutFragment();
    ...
    public static class ConnectTimeOutFragment extends WifiConnectivityGuidedStepFragment {
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            return new GuidanceStylist.Guidance(getString(R.string.title_wifi_could_not_connect_timeout, this.mUserChoiceInfo.getWifiConfiguration().getPrintableSsid()), (String) null, (String) null, (Drawable) null);
        }
