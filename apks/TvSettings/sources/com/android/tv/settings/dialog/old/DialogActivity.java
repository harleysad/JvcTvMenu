...
public abstract class DialogActivity extends InstrumentedActivity implements ActionAdapter.Listener, FragmentManager.OnBackStackChangedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mLayoutResId == R.layout.lb_dialog_fragment) {
