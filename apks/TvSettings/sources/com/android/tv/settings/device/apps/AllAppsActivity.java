...
public class AllAppsActivity extends TvSettingsActivity {
    ...
    public Fragment createSettingsFragment() {
        ...
        return FeatureFactory.getFactory(this).getSettingsFragmentProvider().newSettingsFragment(AllAppsFragment.class.getName(), getArguments(volumeUuid, volumeName));
    }
