    ...
    public ProgressPreference(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mAccDelegate = new View.AccessibilityDelegate() {
            ...
            public boolean onRequestSendAccessibilityEvent(ViewGroup host, View child, AccessibilityEvent event) {
                MtkLog.d(ProgressPreference.TAG, "onRequestSendAccessibilityEvent. start " + host + "," + child + "," + event);
                return host.onRequestSendAccessibilityEventInternal(child, event);
            }
        };
        this.isTTSEnable = TextToSpeechUtil.isTTSEnabled(context);
        this.ttUtil = new TextToSpeechUtil(context);
        setLayoutResource(R.layout.partner_progress_preference);
    }
