...
public class ColorTuneSaturationFragment extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    private String TAG = "ColorTuneSaturationFragment";
    ...
    private void createPreferences() {
        ...
        mScreen.setTitle((int) R.string.device_picture_saturation);
        new ArrayList();
        List<String> prefKeys = PartnerSettingsConfig.getSettingsList(PartnerSettingsConfig.ATTR_PICTURE_COLOR_TUNE_SATURATION);
        for (int i = 0; i < prefKeys.size(); i++) {
            ...
            if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_SATURATION_RED)) {
            ...
            } else if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_SATURATION_GREEN)) {
            ...
            } else if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_SATURATION_BLUE)) {
            ...
            } else if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_SATURATION_CVAN)) {
            ...
            } else if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_SATURATION_MEGENTA)) {
            ...
            } else if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_SATURATION_YELLOW)) {
            ...
            } else if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_SATURATION_FLESH_TONE)) {
