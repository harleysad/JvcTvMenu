...
public class ColorTuneOffsetFragment extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    private String TAG = "ColorTuneOffsetFragment";
    ...
    private void createPreferences() {
        ...
        mScreen.setTitle((int) R.string.device_picture_color_tune_offset);
        new ArrayList();
        List<String> prefKeys = PartnerSettingsConfig.getSettingsList(PartnerSettingsConfig.ATTR_PICTURE_COLOR_TUNE_OFFSET);
        for (int i = 0; i < prefKeys.size(); i++) {
            ...
            if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_OFFSET_RED)) {
            ...
            } else if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_OFFSET_GREEN)) {
            ...
            } else if (prefKey.equals(PreferenceConfigUtils.KEY_PICTURE_COLOR_TUNE_OFFSET_BLUE)) {
