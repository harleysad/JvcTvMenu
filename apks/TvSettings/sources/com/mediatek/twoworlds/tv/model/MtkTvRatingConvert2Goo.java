...
public class MtkTvRatingConvert2Goo {
    ...
    private void initAgeMap() {
        ...
        this.mAgeMap.put("SG_TV_R21", 19);
        this.mAgeMap.put("NZ_TV_G", 4);
        this.mAgeMap.put("NZ_TV_PGR", 10);
        this.mAgeMap.put("NZ_TV_AO", 12);
        this.mAgeMap.put("ZA_TV_PG10", 4);
        this.mAgeMap.put("ZA_TV_10", 6);
        this.mAgeMap.put("ZA_TV_PG13", 7);
        this.mAgeMap.put("ZA_TV_13", 10);
        this.mAgeMap.put("ZA_TV_16", 11);
        this.mAgeMap.put("ZA_TV_18", 14);
        this.mAgeMap.put("ZA_TV_R18", 17);
    ...
    public int createSpecialRating4ChLock() {
        setRatingSystem(RATING_SYS_STR_DVB);
    ...
    private int convertBRTV2TCRFormat() {
        if (this.mRatingSystem.equals(RATING_SYS_STR_BR_TV)) {
    ...
    private int convert2TCRFormat() {
        if (this.mRatingSystem == null || this.mRatingSystem.length() == 0) {
            ...
            return ret;
        } else if (this.mRatingSystem.equals(RATING_SYS_STR_AU_TV)) {
            int ret2 = convertAUTV2TCRFormat();
            Log.d(TAG, "convert2TCRFormat: " + toString());
            return ret2;
        } else if (this.mRatingSystem.equals(RATING_SYS_STR_BR_TV)) {
            int ret3 = convertBRTV2TCRFormat();
            Log.d(TAG, "convert2TCRFormat: " + toString());
            return ret3;
        } else if (this.mRatingSystem.equals(RATING_SYS_STR_DVB)) {
            ...
            Log.d(TAG, "convert2TCRFormat: " + toString());
            return ret8;
        } else if (this.mRatingSystem.equals(RATING_SYS_STR_SG_TV)) {
    ...
    public int getRatingType(String ratingSystem) {
        if (ratingSystem.equals(RATING_SYS_STR_ISDB) || ratingSystem.equals(RATING_SYS_STR_AR_TV) || ratingSystem.equals(RATING_SYS_STR_BR_TV)) {
            return 0;
        }
        if (ratingSystem.equals(RATING_SYS_STR_US_TV)) {
            return 2;
        }
        if (ratingSystem.equals(RATING_SYS_STR_US_MV)) {
            return 3;
        }
