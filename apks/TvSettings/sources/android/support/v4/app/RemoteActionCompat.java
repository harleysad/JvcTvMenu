...
public final class RemoteActionCompat {
    ...
    public Bundle toBundle() {
        ...
        bundle.putCharSequence(EXTRA_TITLE, this.mTitle);
    ...
    public static RemoteActionCompat createFromBundle(@NonNull Bundle bundle) {
        RemoteActionCompat action = new RemoteActionCompat(IconCompat.createFromBundle(bundle.getBundle(EXTRA_ICON)), bundle.getCharSequence(EXTRA_TITLE), bundle.getCharSequence(EXTRA_CONTENT_DESCRIPTION), (PendingIntent) bundle.getParcelable("action"));
