...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:148:0x0326, code lost:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:173:0x03a3, code lost:
        r1 = loadAnimation(r8, r17, false, r18);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:174:0x03ac, code lost:
        r2 = r17;
        r4 = r18;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:175:0x03b0, code lost:
        r8.mPostponedAlpha = 0.0f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:176:0x03b2, code lost:
        if (r1 == null) goto L_0x03b7;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:177:0x03b4, code lost:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:192:0x0402, code lost:
        if (r8.getAnimatingAway() != null) goto L_0x0449;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:194:0x0408, code lost:
        if (r8.getAnimator() == null) goto L_0x040b;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:199:0x0427, code lost:
        if (r8.mRetaining != false) goto L_0x0430;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:88:0x01ca, code lost:
        if (r8.mFromLayout != false) goto L_0x028f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:89:0x01cc, code lost:
        r0 = null;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:90:0x01cf, code lost:
        if (r8.mContainerId == 0) goto L_0x0242;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:92:0x01d4, code lost:
        if (r8.mContainerId != -1) goto L_0x01f4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:95:0x01fe, code lost:
        if (r2 != null) goto L_0x0241;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:97:0x0202, code lost:
        if (r8.mRestored != false) goto L_0x0241;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:99:?, code lost:
        r0 = r8.getResources().getResourceName(r8.mContainerId);
     */
    /* JADX WARNING: Removed duplicated region for block: B:211:0x0451  */
    ...
    public void moveToState(android.support.v4.app.Fragment r15, int r16, int r17, int r18, boolean r19) {
        ...
        L_0x0037:
            ...
            return
        L_0x0046:
            android.view.View r1 = r8.getAnimatingAway()
            if (r1 != 0) goto L_0x0052
            android.animation.Animator r1 = r8.getAnimator()
            if (r1 == 0) goto L_0x0064
        L_0x0052:
            r8.setAnimatingAway(r12)
            r8.setAnimator(r12)
            int r3 = r8.getStateAfterAnimating()
            r4 = 0
            r5 = 0
            r6 = 1
            r1 = r7
        ...
        L_0x013e:
            ...
            r7.dispatchOnFragmentPreAttached(r8, r1, r13)
            r8.mCalled = r13
            android.support.v4.app.FragmentHostCallback r1 = r7.mHost
            android.content.Context r1 = r1.getContext()
        ...
        L_0x0165:
            android.support.v4.app.FragmentHostCallback r1 = r7.mHost
            android.content.Context r1 = r1.getContext()
            r7.dispatchOnFragmentAttached(r8, r1, r13)
            boolean r1 = r8.mIsCreated
            if (r1 != 0) goto L_0x0182
            android.os.Bundle r1 = r8.mSavedFragmentState
            r7.dispatchOnFragmentPreCreated(r8, r1, r13)
            android.os.Bundle r1 = r8.mSavedFragmentState
            r8.performCreate(r1)
            android.os.Bundle r1 = r8.mSavedFragmentState
            r7.dispatchOnFragmentCreated(r8, r1, r13)
            goto L_0x0189
        L_0x0182:
            android.os.Bundle r1 = r8.mSavedFragmentState
        ...
        L_0x01f4:
            ...
            android.content.res.Resources r0 = r8.getResources()     // Catch:{ NotFoundException -> 0x020f }
            int r3 = r8.mContainerId     // Catch:{ NotFoundException -> 0x020f }
            java.lang.String r0 = r0.getResourceName(r3)     // Catch:{ NotFoundException -> 0x020f }
            goto L_0x0212
        L_0x020f:
            r0 = move-exception
        ...
        L_0x026e:
            ...
            android.view.View r2 = r8.mView
            android.os.Bundle r3 = r8.mSavedFragmentState
            r7.dispatchOnFragmentViewCreated(r8, r2, r3, r13)
            android.view.View r2 = r8.mView
        ...
        L_0x028f:
            ...
            android.os.Bundle r0 = r8.mSavedFragmentState
            r7.dispatchOnFragmentActivityCreated(r8, r0, r13)
        ...
        L_0x02c1:
            r8.performStart()
            r7.dispatchOnFragmentStarted(r8, r13)
        L_0x02c7:
            if (r0 <= r10) goto L_0x02ed
            boolean r1 = DEBUG
        ...
        L_0x02e3:
            r8.performResume()
            r7.dispatchOnFragmentResumed(r8, r13)
            r8.mSavedFragmentState = r12
        ...
        L_0x031a:
            r8.performPause()
            r7.dispatchOnFragmentPaused(r8, r13)
        L_0x0320:
        ...
        L_0x033c:
            r8.performStop()
            r7.dispatchOnFragmentStopped(r8, r13)
        L_0x0342:
            if (r0 >= r11) goto L_0x03d3
            boolean r1 = DEBUG
        ...
        L_0x0371:
            r8.performDestroyView()
            r7.dispatchOnFragmentViewDestroyed(r8, r13)
            android.view.View r1 = r8.mView
            ...
            r2 = r17
            r4 = r18
            android.support.v4.app.FragmentManagerImpl$AnimationOrAnimator r1 = r7.loadAnimation(r8, r2, r13, r4)
            goto L_0x03b0
        L_0x03ac:
            r2 = r17
            r4 = r18
        ...
        L_0x0425:
            ...
            r8.performDestroy()
            r7.dispatchOnFragmentDestroyed(r8, r13)
            goto L_0x0432
        L_0x0430:
            r8.mState = r13
        L_0x0432:
            r8.performDetach()
            r7.dispatchOnFragmentDetached(r8, r13)
