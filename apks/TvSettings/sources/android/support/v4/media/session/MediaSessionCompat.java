        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r8, android.os.Bundle r9, android.os.ResultReceiver r10) {
                /*
                    ...
                    boolean r0 = r8.equals(r0)     // Catch:{ BadParcelableException -> 0x00f7 }
                    r1 = 0
                    if (r0 == 0) goto L_0x0047
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00f7 }
                    java.lang.ref.WeakReference r0 = r0.mSessionImpl     // Catch:{ BadParcelableException -> 0x00f7 }
                    java.lang.Object r0 = r0.get()     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r0 = (android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r0     // Catch:{ BadParcelableException -> 0x00f7 }
                    if (r0 == 0) goto L_0x0045
                    android.os.Bundle r2 = new android.os.Bundle     // Catch:{ BadParcelableException -> 0x00f7 }
                    r2.<init>()     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.session.MediaSessionCompat$Token r3 = r0.getSessionToken()     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.session.IMediaSession r4 = r3.getExtraBinder()     // Catch:{ BadParcelableException -> 0x00f7 }
                    java.lang.String r5 = "android.support.v4.media.session.EXTRA_BINDER"
                    if (r4 != 0) goto L_0x002a
                    r6 = r1
                    goto L_0x002e
                L_0x002a:
                    android.os.IBinder r6 = r4.asBinder()     // Catch:{ BadParcelableException -> 0x00f7 }
                L_0x002e:
                    android.support.v4.app.BundleCompat.putBinder(r2, r5, r6)     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.SessionToken2 r5 = r3.getSessionToken2()     // Catch:{ BadParcelableException -> 0x00f7 }
                    java.lang.String r6 = "android.support.v4.media.session.SESSION_TOKEN2"
                    if (r5 != 0) goto L_0x003a
                    goto L_0x003e
                L_0x003a:
                    android.os.Bundle r1 = r5.toBundle()     // Catch:{ BadParcelableException -> 0x00f7 }
                L_0x003e:
                    r2.putBundle(r6, r1)     // Catch:{ BadParcelableException -> 0x00f7 }
                    r1 = 0
                    r10.send(r1, r2)     // Catch:{ BadParcelableException -> 0x00f7 }
                L_0x0045:
                    goto L_0x00f6
                L_0x0047:
                    ...
                    java.lang.ClassLoader r0 = r0.getClassLoader()     // Catch:{ BadParcelableException -> 0x00f7 }
                    r9.setClassLoader(r0)     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00f7 }
                    java.lang.String r1 = "android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"
                    android.os.Parcelable r1 = r9.getParcelable(r1)     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00f7 }
                    r0.onAddQueueItem(r1)     // Catch:{ BadParcelableException -> 0x00f7 }
                    goto L_0x00f6
                L_0x0067:
                    ...
                    int r2 = r9.getInt(r2)     // Catch:{ BadParcelableException -> 0x00f7 }
                    r0.onAddQueueItem(r1, r2)     // Catch:{ BadParcelableException -> 0x00f7 }
                    goto L_0x00f6
                L_0x008c:
                    ...
                    android.os.Parcelable r1 = r9.getParcelable(r1)     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00f7 }
                    r0.onRemoveQueueItem(r1)     // Catch:{ BadParcelableException -> 0x00f7 }
                    goto L_0x00f6
                L_0x00ab:
                    ...
                    java.util.List r2 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00f7 }
                    if (r2 == 0) goto L_0x00f0
                    java.lang.String r2 = "android.support.v4.media.session.command.ARGUMENT_INDEX"
                    r3 = -1
                    int r2 = r9.getInt(r2, r3)     // Catch:{ BadParcelableException -> 0x00f7 }
                    if (r2 < 0) goto L_0x00e5
                    java.util.List r3 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00f7 }
                    int r3 = r3.size()     // Catch:{ BadParcelableException -> 0x00f7 }
                    if (r2 >= r3) goto L_0x00e5
                    java.util.List r1 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00f7 }
                    java.lang.Object r1 = r1.get(r2)     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.session.MediaSessionCompat$QueueItem r1 = (android.support.v4.media.session.MediaSessionCompat.QueueItem) r1     // Catch:{ BadParcelableException -> 0x00f7 }
                L_0x00e5:
                    if (r1 == 0) goto L_0x00f0
                    android.support.v4.media.session.MediaSessionCompat$Callback r3 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00f7 }
                    android.support.v4.media.MediaDescriptionCompat r4 = r1.getDescription()     // Catch:{ BadParcelableException -> 0x00f7 }
                    r3.onRemoveQueueItem(r4)     // Catch:{ BadParcelableException -> 0x00f7 }
                L_0x00f0:
                    goto L_0x00f6
                L_0x00f1:
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00f7 }
                    r0.onCommand(r8, r9, r10)     // Catch:{ BadParcelableException -> 0x00f7 }
                L_0x00f6:
                    goto L_0x00ff
                L_0x00f7:
                    r0 = move-exception
