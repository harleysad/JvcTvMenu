...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingChild2, NestedScrollingParent, NestedScrollingChild {
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int[] offsetInWindow, int type) {
        return type == 0 && dispatchNestedScroll(dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed, offsetInWindow);
    }
