...
public class SearchBar extends RelativeLayout {
    ...
    public void startRecognition() {
        if (!this.mRecognizing) {
            ...
            if (this.mSpeechRecognitionCallback != null) {
                ...
                } else if (Build.VERSION.SDK_INT < 23 || this.mPermissionListener == null) {
    ...
    private void loadSounds(Context context) {
        for (int sound : new int[]{R.raw.lb_voice_failure, R.raw.lb_voice_open, R.raw.lb_voice_no_input, R.raw.lb_voice_success}) {
