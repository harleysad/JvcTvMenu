...
public class DetailsOverviewRowPresenter extends RowPresenter {
    ...
    class ActionsItemBridgeAdapter extends ItemBridgeAdapter {
        ...
        public void onUnbind(ItemBridgeAdapter.ViewHolder ibvh) {
            if (this.mViewHolder.getOnItemViewClickedListener() != null || DetailsOverviewRowPresenter.this.mActionClickedListener != null) {
                ibvh.getPresenter().setOnClickListener(ibvh.getViewHolder(), (View.OnClickListener) null);
            }
        }
        ...
        public void dispatchItemSelection(View view) {
            ...
            if (isSelected()) {
                if (view != null) {
                    ...
                    viewHolder = this.mActionsRow.findViewHolderForPosition(this.mActionsRow.getSelectedPosition());
                }
    ...
    public void onRowViewSelected(RowPresenter.ViewHolder vh, boolean selected) {
        ...
        if (selected) {
            ((ViewHolder) vh).dispatchItemSelection((View) null);
        }
    }
    ...
    private void initDetailsOverview(final ViewHolder vh) {
        ...
        if (!getSelectEffectEnabled()) {
            vh.mOverviewFrame.setForeground((Drawable) null);
        }
    ...
    public void bindImageDrawable(ViewHolder vh) {
        ...
        if (useMargin) {
            ...
            vh.mRightPanel.setBackground((Drawable) null);
            vh.mImageView.setBackground((Drawable) null);
        } else {
            ...
            vh.mOverviewFrame.setBackground((Drawable) null);
        }
