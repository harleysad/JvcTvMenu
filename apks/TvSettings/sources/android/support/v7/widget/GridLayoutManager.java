...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        while (i4 < count) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view4) != maxSize3) {
                ...
                if (this.mOrientation == 1) {
                    ...
                    hSpec = View.MeasureSpec.makeMeasureSpec(maxSize3 - verticalInsets, 1073741824);
                    LayoutParams layoutParams = lp;
                } else {
                    flexibleInOtherDir = flexibleInOtherDir2;
                    wSpec = View.MeasureSpec.makeMeasureSpec(maxSize3 - horizontalInsets, 1073741824);
        ...
        layoutChunkResult.mConsumed = maxSize3;
        int left2 = 0;
        int right2 = 0;
        int top2 = 0;
        int bottom2 = 0;
