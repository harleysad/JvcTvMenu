...
public class AnimatorInflaterCompat {
    ...
    private static android.animation.PropertyValuesHolder getPVH(android.content.res.TypedArray r23, int r24, int r25, int r26, java.lang.String r27) {
        ...
        L_0x006a:
            ...
            boolean r20 = android.support.v4.graphics.PathParser.canMorph(r15, r4)
    ...
    private static int inferValueTypeOfKeyframe(Resources res, Resources.Theme theme, AttributeSet attrs, XmlPullParser parser) {
        ...
        int valueType = 0;
        TypedValue keyframeValue = TypedArrayUtils.peekNamedValue(a, parser, SaveValue.GLOBAL_VALUE_VALUE, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources res, Resources.Theme theme, AttributeSet attrs, int valueType, XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        if (hasValue) {
            if (valueType != 3) {
                switch (valueType) {
                    case 0:
                        keyframe2 = Keyframe.ofFloat(fraction, TypedArrayUtils.getNamedFloat(a, parser, SaveValue.GLOBAL_VALUE_VALUE, 0, 0.0f));
                        break;
                    case 1:
                        break;
                }
            }
            keyframe2 = Keyframe.ofInt(fraction, TypedArrayUtils.getNamedInt(a, parser, SaveValue.GLOBAL_VALUE_VALUE, 0, 0));
        } else {
            if (valueType == 0) {
