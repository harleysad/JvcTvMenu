...
public class SliceActionImpl implements SliceAction {
    ...
    public SliceActionImpl(SliceItem slice) {
        ...
        SliceItem actionItem = SliceQuery.find(slice, BaseDialogFragment.TAG_ACTION);
        if (actionItem != null) {
            this.mActionItem = actionItem;
            SliceItem iconItem = SliceQuery.find(actionItem.getSlice(), "image");
            if (iconItem != null) {
                this.mIcon = iconItem.getIcon();
                this.mImageMode = iconItem.hasHint("no_tint") ? iconItem.hasHint("large") ? 2 : 1 : 0;
            }
            ...
            this.mPriority = priority != null ? priority.getInt() : i;
        }
    }
    ...
    public Slice buildSlice(@NonNull Slice.Builder builder) {
        ...
        String subtype = null;
        if (this.mIcon != null) {
            sb.addIcon(this.mIcon, (String) null, this.mImageMode == 0 ? new String[0] : new String[]{"no_tint"});
        }
        if (this.mTitle != null) {
