...
public final class Channel {
    ...
    public boolean isLocked() {
        Integer i = this.mValues.getAsInteger(TvContractCompat.Channels.COLUMN_LOCKED);
        return i != null && i.intValue() == 1;
    }
    ...
    public ContentValues toContentValues(boolean includeProtectedFields) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            values.remove(TvContractCompat.Channels.COLUMN_CONFIGURATION_DISPLAY_ORDER);
            values.remove(TvContractCompat.Channels.COLUMN_SYSTEM_CHANNEL_KEY);
        }
        if (!includeProtectedFields) {
            values.remove("browsable");
            values.remove(TvContractCompat.Channels.COLUMN_LOCKED);
        }
    ...
    private static String[] getProjection() {
        ...
        String[] oReleaseColumns = {"internal_provider_id", "transient", TvContractCompat.Channels.COLUMN_SYSTEM_APPROVED, TvContractCompat.Channels.COLUMN_CONFIGURATION_DISPLAY_ORDER, TvContractCompat.Channels.COLUMN_SYSTEM_CHANNEL_KEY};
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static final class Builder {
        ...
        public Builder setPackageName(String packageName) {
            this.mValues.put(TvContractCompat.BaseTvColumns.COLUMN_PACKAGE_NAME, packageName);
            return this;
        }
        ...
        public Builder setDescription(String description) {
            this.mValues.put("description", description);
            return this;
        }
        ...
        public Builder setConfigurationDisplayOrder(int value) {
            this.mValues.put(TvContractCompat.Channels.COLUMN_CONFIGURATION_DISPLAY_ORDER, Integer.valueOf(value));
            return this;
        }

        public Builder setSystemChannelKey(String value) {
            this.mValues.put(TvContractCompat.Channels.COLUMN_SYSTEM_CHANNEL_KEY, value);
            return this;
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setLocked(boolean value) {
            this.mValues.put(TvContractCompat.Channels.COLUMN_LOCKED, Integer.valueOf(value));
            return this;
        }
