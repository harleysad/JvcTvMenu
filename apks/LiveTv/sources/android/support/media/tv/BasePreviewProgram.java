...
public abstract class BasePreviewProgram extends BaseProgram {
    ...
    public Uri getPreviewAudioUri() {
        String uri = this.mValues.getAsString(TvContractCompat.PreviewProgramColumns.COLUMN_PREVIEW_AUDIO_URI);
        if (uri == null) {
            return null;
        }
        return Uri.parse(uri);
    ...
    public ContentValues toContentValues(boolean includeProtectedFields) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            values.remove(TvContractCompat.PreviewProgramColumns.COLUMN_CONTENT_ID);
            values.remove(TvContractCompat.PreviewProgramColumns.COLUMN_LOGO_CONTENT_DESCRIPTION);
            values.remove(TvContractCompat.PreviewProgramColumns.COLUMN_GENRE);
            values.remove("start_time_utc_millis");
            values.remove("end_time_utc_millis");
            values.remove(TvContractCompat.PreviewProgramColumns.COLUMN_PREVIEW_AUDIO_URI);
            values.remove(TvContractCompat.PreviewProgramColumns.COLUMN_TV_SERIES_ITEM_TYPE);
        }
    ...
    public static abstract class Builder<T extends Builder> extends BaseProgram.Builder<T> {
        ...
        public T setContentId(String contentId) {
            this.mValues.put(TvContractCompat.PreviewProgramColumns.COLUMN_CONTENT_ID, contentId);
            return this;
        }

        public T setLogoContentDescription(String logoContentDescription) {
            this.mValues.put(TvContractCompat.PreviewProgramColumns.COLUMN_LOGO_CONTENT_DESCRIPTION, logoContentDescription);
            return this;
        }

        public T setGenre(String genre) {
            this.mValues.put(TvContractCompat.PreviewProgramColumns.COLUMN_GENRE, genre);
            return this;
        }
        ...
        public T setTvSeriesItemType(int type) {
            this.mValues.put(TvContractCompat.PreviewProgramColumns.COLUMN_TV_SERIES_ITEM_TYPE, Integer.valueOf(type));
            return this;
        }
    }
}
