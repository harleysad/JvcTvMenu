...
public class PlaybackFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        FragmentUtil.getContext(this).getTheme().resolveAttribute(R.attr.playbackControlsAutoHideTimeout, outValue, true);
        this.mAutohideTimerAfterPlayingInMs = outValue.data;
        FragmentUtil.getContext(this).getTheme().resolveAttribute(R.attr.playbackControlsAutoHideTickleTimeout, outValue, true);
