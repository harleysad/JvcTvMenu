...
public class DetailsFragmentBackgroundController {
    ...
    public void enableParallax() {
        ...
        enableParallax(coverDrawable, new ColorDrawable(), new ParallaxTarget.PropertyValuesHolderTarget(coverDrawable, PropertyValuesHolder.ofInt(FitWidthBitmapDrawable.PROPERTY_VERTICAL_OFFSET, new int[]{0, -offset})));
    }
