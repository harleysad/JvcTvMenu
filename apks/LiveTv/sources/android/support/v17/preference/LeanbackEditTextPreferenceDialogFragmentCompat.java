...
public class LeanbackEditTextPreferenceDialogFragmentCompat extends LeanbackPreferenceDialogFragmentCompat {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.cloneInContext(new ContextThemeWrapper(getActivity(), theme)).inflate(R.layout.leanback_edit_preference_fragment, container, false);
        if (!TextUtils.isEmpty(this.mDialogTitle)) {
            ((TextView) view.findViewById(R.id.decor_title)).setText(this.mDialogTitle);
        }
