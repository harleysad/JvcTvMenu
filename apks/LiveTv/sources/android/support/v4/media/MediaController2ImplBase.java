...
class MediaController2ImplBase implements MediaController2.SupportLibraryImpl {
    ...
    public void close() {
        ...
        L_0x001c:
            ...
            monitor-enter(r0)
            r1 = 0
            android.support.v4.media.IMediaSession2 r2 = r6.mISession2     // Catch:{ all -> 0x0060 }
            boolean r3 = r6.mIsReleased     // Catch:{ all -> 0x005e }
        ...
        L_0x0028:
            ...
            android.support.v4.media.MediaController2ImplBase$SessionServiceConnection r3 = r6.mServiceConnection     // Catch:{ all -> 0x005e }
            if (r3 == 0) goto L_0x0038
            android.content.Context r3 = r6.mContext     // Catch:{ all -> 0x005e }
            android.support.v4.media.MediaController2ImplBase$SessionServiceConnection r4 = r6.mServiceConnection     // Catch:{ all -> 0x005e }
            r3.unbindService(r4)     // Catch:{ all -> 0x005e }
            r6.mServiceConnection = r1     // Catch:{ all -> 0x005e }
        L_0x0038:
            r6.mISession2 = r1     // Catch:{ all -> 0x005e }
            android.support.v4.media.MediaController2Stub r1 = r6.mControllerStub     // Catch:{ all -> 0x005e }
            r1.destroy()     // Catch:{ all -> 0x005e }
            monitor-exit(r0)     // Catch:{ all -> 0x005e }
            if (r2 == 0) goto L_0x0053
            android.os.IBinder r0 = r2.asBinder()     // Catch:{ RemoteException -> 0x0052 }
            android.os.IBinder$DeathRecipient r1 = r6.mDeathRecipient     // Catch:{ RemoteException -> 0x0052 }
            r3 = 0
            r0.unlinkToDeath(r1, r3)     // Catch:{ RemoteException -> 0x0052 }
            android.support.v4.media.MediaController2Stub r0 = r6.mControllerStub     // Catch:{ RemoteException -> 0x0052 }
    ...
    public void onConnectedNotLocked(android.support.v4.media.IMediaSession2 r18, android.support.v4.media.SessionCommandGroup2 r19, int r20, android.support.v4.media.MediaItem2 r21, long r22, long r24, float r26, long r27, android.support.v4.media.MediaController2.PlaybackInfo r29, int r30, int r31, java.util.List<android.support.v4.media.MediaItem2> r32, android.app.PendingIntent r33) {
        ...
        L_0x0028:
            ...
            goto L_0x00ef
        L_0x002f:
            java.lang.Object r5 = r1.mLock     // Catch:{ all -> 0x00da }
            monitor-enter(r5)     // Catch:{ all -> 0x00da }
            boolean r0 = r1.mIsReleased     // Catch:{ all -> 0x00c7 }
        ...
        L_0x003e:
            return
        L_0x003f:
            android.support.v4.media.IMediaSession2 r0 = r1.mISession2     // Catch:{ all -> 0x00c7 }
        ...
        L_0x0054:
            ...
            android.support.v4.media.IMediaSession2 r0 = r1.mISession2     // Catch:{ RemoteException -> 0x00a4 }
            android.os.IBinder r0 = r0.asBinder()     // Catch:{ RemoteException -> 0x00a4 }
            android.os.IBinder$DeathRecipient r2 = r1.mDeathRecipient     // Catch:{ RemoteException -> 0x00a4 }
            r6 = 0
            r0.linkToDeath(r2, r6)     // Catch:{ RemoteException -> 0x00a4 }
            monitor-exit(r5)     // Catch:{ all -> 0x00d8 }
            java.util.concurrent.Executor r0 = r1.mCallbackExecutor     // Catch:{ all -> 0x00d6 }
            android.support.v4.media.MediaController2ImplBase$15 r2 = new android.support.v4.media.MediaController2ImplBase$15     // Catch:{ all -> 0x00d6 }
        ...
        L_0x00a4:
            r0 = move-exception
            boolean r2 = DEBUG     // Catch:{ all -> 0x00d8 }
        ...
        L_0x00b0:
            ...
            android.support.v4.media.MediaController2 r4 = r1.mInstance
            r4.close()
        L_0x00b9:
            return
        L_0x00ba:
