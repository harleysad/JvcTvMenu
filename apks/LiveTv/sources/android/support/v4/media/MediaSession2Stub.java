        ...
        if (!this.mSession.isClosed() && controller != null) {
            ...
            this.mSession.getCallbackExecutor().execute(new Runnable() {
                ...
                public void run() {
                    /*
                        r5 = this;
                        android.support.v4.media.MediaSession2Stub r0 = android.support.v4.media.MediaSession2Stub.this
                        java.lang.Object r0 = r0.mLock
                        monitor-enter(r0)
                        android.support.v4.media.MediaSession2Stub r1 = android.support.v4.media.MediaSession2Stub.this     // Catch:{ all -> 0x00c0 }
                        android.support.v4.util.ArrayMap r1 = r1.mControllers     // Catch:{ all -> 0x00c0 }
                        android.support.v4.media.MediaSession2$ControllerInfo r2 = r4     // Catch:{ all -> 0x00c0 }
                        boolean r1 = r1.containsValue(r2)     // Catch:{ all -> 0x00c0 }
                        if (r1 != 0) goto L_0x0017
                        monitor-exit(r0)     // Catch:{ all -> 0x00c0 }
                        return
                    L_0x0017:
                        monitor-exit(r0)     // Catch:{ all -> 0x00c0 }
                        android.support.v4.media.SessionCommand2 r0 = r5
                        if (r0 == 0) goto L_0x003a
                        android.support.v4.media.MediaSession2Stub r0 = android.support.v4.media.MediaSession2Stub.this
                        android.support.v4.media.MediaSession2$ControllerInfo r1 = r4
                        android.support.v4.media.SessionCommand2 r2 = r5
                        boolean r0 = r0.isAllowedCommand((android.support.v4.media.MediaSession2.ControllerInfo) r1, (android.support.v4.media.SessionCommand2) r2)
                        if (r0 != 0) goto L_0x0029
                        return
                    L_0x0029:
                        android.util.SparseArray r0 = android.support.v4.media.MediaSession2Stub.sCommandsForOnCommandRequest
                        android.support.v4.media.SessionCommand2 r1 = r5
                        int r1 = r1.getCommandCode()
                        java.lang.Object r0 = r0.get(r1)
                        android.support.v4.media.SessionCommand2 r0 = (android.support.v4.media.SessionCommand2) r0
                        goto L_0x0053
                    L_0x003a:
                        android.support.v4.media.MediaSession2Stub r0 = android.support.v4.media.MediaSession2Stub.this
                        android.support.v4.media.MediaSession2$ControllerInfo r1 = r4
                        int r2 = r6
                        boolean r0 = r0.isAllowedCommand((android.support.v4.media.MediaSession2.ControllerInfo) r1, (int) r2)
                    ...
                    L_0x0053:
                        ...
                        android.support.v4.media.MediaSession2Stub r1 = android.support.v4.media.MediaSession2Stub.this
                        ...
                        android.support.v4.media.MediaSession2Stub r2 = android.support.v4.media.MediaSession2Stub.this
                        ...
                        android.support.v4.media.MediaSession2$ControllerInfo r3 = r4
                        ...
                        r3.append(r4)
                        android.support.v4.media.MediaSession2$ControllerInfo r4 = r4
                        r3.append(r4)
                        java.lang.String r4 = " was rejected by "
                        r3.append(r4)
                        android.support.v4.media.MediaSession2Stub r4 = android.support.v4.media.MediaSession2Stub.this
                        ...
                        return
                    L_0x009a:
                        android.support.v4.media.MediaSession2Stub$SessionRunnable r1 = r7     // Catch:{ RemoteException -> 0x00a2 }
                        android.support.v4.media.MediaSession2$ControllerInfo r2 = r4     // Catch:{ RemoteException -> 0x00a2 }
        ...
        this.mSession.getCallbackExecutor().execute(new Runnable() {
            public void run() {
                if (!MediaSession2Stub.this.mSession.isClosed()) {
                    ...
                    if (allowedCommands != null || controllerInfo.isTrusted()) {
