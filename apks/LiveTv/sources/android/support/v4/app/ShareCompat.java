...
import com.mediatek.wwtv.tvcenter.distributor.FVPIntentBasic;
...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        private Intent mIntent = new Intent().setAction(FVPIntentBasic.FVP_ACTION);
        ...
        public Intent getIntent() {
            ...
            if (!needsSendMultiple && isSendMultiple) {
                this.mIntent.setAction(FVPIntentBasic.FVP_ACTION);
        ...
        public IntentBuilder setStream(Uri streamUri) {
            if (!this.mIntent.getAction().equals(FVPIntentBasic.FVP_ACTION)) {
                this.mIntent.setAction(FVPIntentBasic.FVP_ACTION);
            }
            this.mStreams = null;
    ...
    public static class IntentReader {
        ...
        public boolean isShareIntent() {
            ...
            return FVPIntentBasic.FVP_ACTION.equals(action) || "android.intent.action.SEND_MULTIPLE".equals(action);
        }

        public boolean isSingleShare() {
            return FVPIntentBasic.FVP_ACTION.equals(this.mIntent.getAction());
        }
