...
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    private static final Executor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(5, 128, 1, TimeUnit.SECONDS, new LinkedBlockingQueue(10), new CountingThreadFactory());
    ...
    static final class CountingThreadFactory extends AtomicInteger implements ThreadFactory {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "AsyncTaskLoader #" + incrementAndGet());
        }
    }
