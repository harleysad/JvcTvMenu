...
public class MtkTvAppTVBase {
    ...
    private static void setSysStatus_map() {
        ...
        SysStatus_map.put("Before_ASP_Ratio_chg", 8);
        SysStatus_map.put("After_ASP_Ratio_chg", 9);
        SysStatus_map.put("Before_Zoom_Mode_Chg", 10);
        SysStatus_map.put("SAfter_Zoom_Mode_Chg", 11);
    }
