...
public final class ScrollAdapterView extends AdapterView<Adapter> {
    ...
    private static final float LATCH_THRESHOLD = 1000.0f;
    ...
    private static final int SOURCE_TOUCH_NAV = 2097152;
    ...
    public ScrollAdapterErrorHandler mAdapterErrorHandler;
    /* access modifiers changed from: private */
    ...
    private ArrayList<OnItemChangeListener> mOnItemChangeListeners = new ArrayList<>();
    ...
    private RecycledViews mRecycleExpandedViews = new RecycledViews(3);
    private RecycledViews mRecycleViews = new RecycledViews(10);
    private int mRightIndex;
    private int mScrapHeight;
    private int mScrapWidth;
    private ScrollController mScroll = new ScrollController(getContext());
        ...
        public void run() {
            try {
                ...
                if (ScrollAdapterView.this.mAdapterErrorHandler != null) {
                    ScrollAdapterView.this.mAdapterErrorHandler.onError(ex);
                } else {
                    ex.printStackTrace();
                }
            }
    ...
    public void setErrorHandler(ScrollAdapterErrorHandler errorHandler) {
        this.mAdapterErrorHandler = errorHandler;
    }
    ...
    private void pruneInvisibleViewsInLayout() {
        ...
        if (this.mScroll.isFinished() || this.mScroll.isMainAxisMovingForward()) {
            while (true) {
                ...
                View childAt = getChildAt(lastExpandableIndex() - 1);
                if (this.mOrientation != 0) {
    ...
    private boolean fillOneAxis(int r18, int r19, boolean r20, boolean r21) {
        /*
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapter r3 = r0.mAdapter
            int r3 = r3.getCount()
        ...
        L_0x0073:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ChildViewHolder r11 = (com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.ChildViewHolder) r11
            r11.mMaxSize = r4
            int r12 = r0.mOrientation
            if (r12 != 0) goto L_0x00db
            com.mediatek.wwtv.setting.widget.view.ScrollController r12 = r0.mScroll
        ...
        L_0x012a:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandableChildStates r12 = r0.mExpandableChildStates
        ...
        L_0x0145:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapter r13 = r0.mAdapter
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollController r5 = r0.mScroll
        ...
        L_0x0181:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.fillOneAxis(int, int, boolean, boolean):boolean");
    }
    ...
    private void restoreLoadingState() {
        ...
        if (this.mPendingSelection >= 0) {
            ...
            Bundle expandableChildStates = this.mLoadingState.expandableChildStates;
            Bundle expandedChildStates = this.mLoadingState.expandedChildStates;
        } else {
            boolean z = hasFocus;
            return;
        }
        ...
        if (selection < 0) {
            boolean z2 = hasFocus;
        } else if (selection >= this.mAdapter.getCount()) {
            int i = viewLoc;
            boolean z3 = hasFocus;
        } else {
            ...
            if (this.mScroll.mainAxis().getScrollCenter() <= finalLocation) {
                while (true) {
                    if (scrollCenter >= finalLocation) {
                        boolean z5 = hasFocus;
                        break;
                    }
                    int fillWindowRight2 = fillWindowRight;
                    ...
                    fillWindowRight = fillWindowRight2;
                    hasFocus = hasFocus2;
                }
            } else {
                boolean z7 = hasFocus;
    ...
    public boolean onKeyUp(int r10, android.view.KeyEvent r11) {
        ...
        L_0x0009:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapter r2 = r9.mAdapter
        ...
        L_0x002f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.onKeyUp(int, android.view.KeyEvent):boolean");
    }
    ...
    private static boolean isDescendant(android.view.View r3, android.view.View r4) {
        ...
        L_0x0014:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.isDescendant(android.view.View, android.view.View):boolean");
    }
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final android.view.View getTopItem(android.view.View r4) {
        /*
            r3 = this;
            r0 = r3
            r1 = r4
        ...
        L_0x001e:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.getTopItem(android.view.View):android.view.View");
    }
    ...
    private void updateViewsLocations(boolean r59) {
        /*
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterBase r2 = r0.mExpandAdapter
            if (r2 != 0) goto L_0x0014
            boolean r2 = r58.selectedItemCanScale()
            if (r2 != 0) goto L_0x0014
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterCustomAlign r2 = r0.mAdapterCustomAlign
        ...
        L_0x001e:
            return
        L_0x001f:
            com.mediatek.wwtv.setting.widget.view.ScrollController r3 = r0.mScroll
            com.mediatek.wwtv.setting.widget.view.ScrollController$Axis r3 = r3.mainAxis()
            int r3 = r3.getScrollCenter()
            com.mediatek.wwtv.setting.widget.view.ScrollController r4 = r0.mScroll
            com.mediatek.wwtv.setting.widget.view.ScrollController$Axis r4 = r4.secondAxis()
            int r4 = r4.getScrollCenter()
            java.util.ArrayList<com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView> r5 = r0.mExpandedViews
            int r5 = r5.size()
            r6 = -1
            r7 = -1
            r8 = -1
        ...
        L_0x006e:
            r2 = r6
            r3 = r14
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterCustomAlign r8 = r0.mAdapterCustomAlign
        ...
        L_0x0092:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterCustomAlign r13 = r0.mAdapterCustomAlign
        ...
        L_0x00b7:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView r14 = r0.getOrCreateExpandedView(r13)
            r15 = 0
            if (r3 == r2) goto L_0x00c9
            int r2 = r0.mItemsOnOffAxis
            int r2 = r2 + r13
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView r15 = r0.getOrCreateExpandedView(r2)
        L_0x00c9:
            r2 = 0
            r19 = r1
            r1 = -1
            ...
            int r1 = r13 - r1
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView r2 = r0.getOrCreateExpandedView(r1)
        L_0x00d7:
            java.util.ArrayList<com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView> r1 = r0.mExpandedViews
            int r1 = r1.size()
            int r1 = r1 - r5
            int r8 = r8 + r1
            r20 = r4
            ...
            int r3 = r3 + r1
        L_0x00e5:
            java.util.ArrayList<com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView> r4 = r0.mExpandedViews
            int r4 = r4.size()
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollController r1 = r0.mScroll
            com.mediatek.wwtv.setting.widget.view.ScrollController$Axis r1 = r1.mainAxis()
        ...
        L_0x0173:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollController r7 = r0.mScroll
            boolean r7 = r7.isFinished()
            if (r7 == 0) goto L_0x01a8
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterBase r7 = r0.mExpandAdapter
            if (r7 == 0) goto L_0x01a8
            r7 = 1
            goto L_0x01a9
        L_0x01a8:
        ...
        L_0x01dc:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ChildViewHolder r15 = (com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.ChildViewHolder) r15
        ...
        L_0x0243:
            r45 = r2
            com.mediatek.wwtv.setting.widget.view.ScrollController r2 = r0.mScroll
            com.mediatek.wwtv.setting.widget.view.ScrollController$Axis r2 = r2.mainAxis()
        ...
        L_0x0287:
            r47 = r6
            com.mediatek.wwtv.setting.widget.view.ScrollController r6 = r0.mScroll
        ...
        L_0x0334:
            ...
            r6 = r9
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ChildViewHolder r6 = (com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.ChildViewHolder) r6
            r6.mMaxSize = r12
            r9 = 0
        ...
        L_0x037a:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollController r9 = r0.mScroll
            com.mediatek.wwtv.setting.widget.view.ScrollController$Axis r9 = r9.mainAxis()
        ...
        L_0x03ce:
            ...
            r3 = r21
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ChildViewHolder r3 = (com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.ChildViewHolder) r3
        ...
        L_0x04dc:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView r4 = (com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.ExpandedView) r4
            r5 = r44
        ...
        L_0x0507:
            r4.close()
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedChildStates r14 = r0.mExpandedChildStates
            r53 = r6
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$RecycledViews r6 = r0.mRecycleExpandedViews
            android.view.View r7 = r4.expandedView
            int r14 = r4.viewType
            r6.recycleView(r7, r14)
            java.util.ArrayList<com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView> r6 = r0.mExpandedViews
            r6.remove(r2)
            int r3 = r3 + -1
            goto L_0x0543
        L_0x052d:
        ...
        L_0x0560:
            ...
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView r6 = (com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.ExpandedView) r6
        ...
        L_0x05c5:
            ...
            android.view.View r4 = r6.expandedView
            int r4 = r4.getMeasuredWidth()
            android.view.View r8 = r6.expandedView
            int r8 = r8.getMeasuredHeight()
            int r8 = r8 + r7
            r14 = 0
            r3.layout(r14, r7, r4, r8)
        L_0x05d8:
            int r2 = r2 + 1
            r3 = r55
            r4 = r56
        ...
        L_0x05e2:
            ...
            r57 = r8
            r2 = 0
            java.util.ArrayList<com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView> r3 = r0.mExpandedViews
            int r3 = r3.size()
        L_0x05ed:
            ...
            java.lang.Object r4 = r4.get(r2)
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView r4 = (com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.ExpandedView) r4
            if (r4 != r5) goto L_0x05fc
            r6 = r26
            goto L_0x05fe
        L_0x05fc:
            r6 = r27
        L_0x05fe:
            if (r4 == r13) goto L_0x060c
            if (r4 != r12) goto L_0x0609
            r7 = 1065353216(0x3f800000, float:1.0)
        ...
        L_0x060c:
            r7 = 1065353216(0x3f800000, float:1.0)
        L_0x060e:
            android.view.View r8 = r4.expandedView
            r14 = 4
        ...
        L_0x0617:
            ...
            int r6 = r6.size()
        L_0x0636:
            if (r4 >= r6) goto L_0x0658
            java.util.ArrayList<com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView> r7 = r0.mExpandedViews
            java.lang.Object r7 = r7.get(r4)
            com.mediatek.wwtv.setting.widget.view.ScrollAdapterView$ExpandedView r7 = (com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.ExpandedView) r7
            int r8 = r7.index
            int r8 = r0.expandableIndexFromAdapterIndex(r8)
            if (r8 != r3) goto L_0x0655
            android.view.View r8 = r7.expandedView
        ...
        L_0x0658:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mediatek.wwtv.setting.widget.view.ScrollAdapterView.updateViewsLocations(boolean):void");
    }
